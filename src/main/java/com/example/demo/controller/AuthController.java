...
import com.example.demo.service.user.RoleServiceImpl;
...
public class AuthController {
    ...
    public ResponseEntity<?> changeAvatar(HttpServletRequest request, @Valid
    @RequestBody
    ChangeAvatar changeAvatar) {
        String token = jwtTokenFilter.getJwt(request); //! lấy token từ request //
        String username = jwtProvider.getUerNameFromToken(token); //! lấy username từ token //
